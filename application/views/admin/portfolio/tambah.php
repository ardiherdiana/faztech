<?php
// application/views/admin/portfolio/tambah.php
...
<div class="bg-white rounded-lg shadow-md">
    ...
    <div class="p-6 border-b border-gray-200">
        <div class="flex justify-between items-center">
            <h3 class="text-xl font-semibold text-gray-800">Tambah Portfolio Baru</h3>
    ...
    <!-- Form -->
    <div class="p-6">
        <?= form_open_multipart('portfolio/tambah', ['class' => 'space-y-6']) ?>
            <div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Simpan Portfolio
                </button>
            </div>
        <?= form_close() ?>
    </div>
