...
<div class="bg-white rounded-lg shadow-md">
    ...
    <!-- Form -->
    <div class="p-6">
        <?= form_open_multipart('produk/tambah', ['class' => 'space-y-6']) ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="kategori" name="kategori" 
                        ...
                        <option value="Akses Control" <?= set_select('kategori', 'Akses Control') ?>>Akses Control</option>
                        <option value="Router" <?= set_select('kategori', 'Router') ?>>Router</option>
                        <option value="Kabel" <?= set_select('kategori', 'Kabel') ?>>Kabel</option>
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secom-blue-light focus:border-transparent outline-none"
                          placeholder="Masukkan deskripsi produk" required><?= set_value('deskripsi') ?></textarea>
