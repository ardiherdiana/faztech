...
<!-- Hero Section untuk Halaman Portfolio -->
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-12" data-aos="fade-up">
            <nav class="text-sm text-gray-600 mb-4">
                ...
                <span class="text-primary font-medium">Portfolio</span>
            </nav>
            
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                <span class="text-primary">Portfolio</span> Karya Kami
            </h1>
            ...
            <div class="flex justify-center items-center space-x-8 mt-8">
                <div class="text-center">
                    <div class="text-3xl font-bold text-primary"><?= $total_portfolio ?></div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
            ...
            <div class="text-center py-20">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-600 mb-6 max-w-md">
                        Portfolio sedang dalam proses pengembangan. Silakan hubungi kami untuk melihat contoh proyek terbaru.
                    </p>
        ...
        <?php else: ?>
            <!-- Portfolio Grid dengan Masonry Layout -->
            <div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
                <?php foreach($portfolio as $index => $item): ?>
                    <div class="portfolio-item group break-inside-avoid relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3" 
                         data-aos="fade-up" 
                         data-aos-delay="<?= 100 + ($index * 100) ?>">
                        
                        <!-- Portfolio Image Container dengan Aspect Ratio Konsisten -->
                        <div class="portfolio-image-container relative overflow-hidden aspect-square">
                            
                            <?php if(!empty($item->foto) && file_exists('./uploads/portfolio/' . $item->foto)): ?>
            ...
            <div class="text-center mt-16">
                <div class="inline-flex items-center bg-white px-6 py-3 rounded-xl shadow-md">
                    ...
                    <span class="text-gray-700 font-medium">Menampilkan semua <?= count($portfolio) ?> proyek</span>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Portfolio hover enhancement (reduce flicker)
    ...
    window.addEventListener('scroll', function() {
        ...
        // Target only hero section background elements, not portfolio
...
<style>
/* Custom styles untuk portfolio gallery */
.portfolio-item {
...
/* Loading animation untuk gambar - simplified to reduce flicker */
